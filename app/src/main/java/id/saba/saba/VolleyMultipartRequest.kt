...
open class VolleyMultipartRequest(
    mMethod: Int = Method.GET,
    mUrl: String,
    private val response: Response.Listener<NetworkResponse>,
    private val error: Response.ErrorListener
) : Request<NetworkResponse>(mMethod, mUrl, error) {
    ...
    data class DataPart(val fileName: String, val content: ByteArray, var type: String? = null) {
