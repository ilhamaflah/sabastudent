...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.layoutImg.setOnClickListener {
            ...
            } else if (textInputUsernameR_1.editText?.text.toString().trim { it <= ' ' }
                    .isEmpty()) {
                ...
                fun onResponse(response: NetworkResponse) {
                    try {
                        ...
                        if (obj.has("success")) {
                            ...
                            if (arr[2] == "Duplicate entry '" + textInputUsernameR_1.editText?.text.toString() + "' for key 'PRIMARY'") toast(
